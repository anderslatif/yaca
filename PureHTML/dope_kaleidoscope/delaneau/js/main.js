!function e(t, n, i) {
        ...
        var o = function() {
            ...
            return o(e, [{
                ...
                value: function() {
                    ...
                    ;
                    var p, g, v, w, y, b, k, C, E, T, _, x, I, S, P, M = ["./images/first_illustration.jpg", "./images/second_illustration.jpg", "./images/third_illustration.jpg"], j = ["./images/first_illustration_small.jpg", "./images/second_illustration_small.jpg", "./images/third_illustration_small.jpg"], L = 0;
                    p = function() {
                        function u(u) {
                            var d, f, h, m;
                            ...
                            a.loader.once("complete", function() {
                                s.md.mobile() || s.md.phone() || s.md.tablet() ? (p.image = PIXI.Texture.fromImage("../images/first_illustration_small.jpg"),
                                    r.ticker.add(function() {
                                        ...
                                        w.draw()
                                    })) : (p.image = PIXI.Texture.fromImage("../images/first_illustration.jpg"),
                                    r.ticker.add(function() {
                                        o += .03,
    ...
    7: [function(e, t, n) {
        ...
        function i() {
            o.md.mobile() ? (a.add("second_illustration", "../images/second_illustration_small.jpg"),
                a.add("third_illustration", "../images/third_illustration_small.jpg")) : (a.add("second_illustration", "../images/second_illustration.jpg"),
                a.add("third_illustration", "../images/third_illustration.jpg")),
                a.load(),
